            ...
            <div class="col-sm-5 position-absolute top-50 start-50 translate-middle">
                <form class="card p-2" action="" method="POST">
                    ...
                    <div class="card-body mb-3">
                        ...
                        <input type="text" class="form-control" name="nis" id="nis" value="<?= $datas["nis"]; ?>" required autocomplete="off">

                        <label for="nama" class="form-label">Nama :</label>
                        <input type="text" class="form-control" name="nama" id="nama" value="<?= $datas["nama"]; ?>" required autocomplete="off">
                    ...
                    <div class="card-footer">
                        <a href="index.php" onclick="return confirm('Bener gak jadi nich?');">
                            <div class=" btn btn-danger">Gak Jadi ah
                            </div>
                        </a>
                    </div>
                </form>
